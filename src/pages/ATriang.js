                ...
                <div className="div1">
                    ...
                    <form onSubmit={this.onFinish}>
                        <div>
                            ...
                            <input type="number" name="inp"  min={1} max={9999} onChange={e => this.setState({base:e.target.value}) } placeholder={0} step={0.01}/></div>
                        <div><label htmlFor="ins">Lado derecho :</label>
                            <input type="number" name="ins"  min={1} max={9999} onChange={e => this.setState({lado_d:e.target.value}) } placeholder={0} step={0.01}/></div>
                        <div><label htmlFor="inst">Lado izquierdo :</label>
                            <input type="number" name="inst" min={1} max={9999} onChange={e => this.setState({lado_i:e.target.value}) } placeholder={0} step={0.01}/></div>
